...
import { reactify, useStorage } from 'comuse-core'
...
const state = useStorage('comuse-local-storage', theDefault)
const state2 = useStorage('comuse-local-storage', theDefault)
