...
export interface UseAxiosReturn<T, R = AxiosResponse<T>, _D = any, O extends UseAxiosOptions<T> = UseAxiosOptions<T>> {
  /**
   * Axios Response
   */
...
export function useAxios<T = any, R = AxiosResponse<T>, D = any, O extends UseAxiosOptions<T> = UseAxiosOptions<T>>(url: string, config?: AxiosRequestConfig<D>, options?: O): StrictUseAxiosReturn<T, R, D, O> & Promise<StrictUseAxiosReturn<T, R, D, O>>
 ...
 * Wrapper for axios.
 *
 * @see https://ajiu9.cn/comuse/core/useAxios
 */
